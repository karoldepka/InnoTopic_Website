...
/** A multiple-choice option kept apart from the answer HTML, allowing Quiz to reveal
 * correctness without storing a visual correctness hint in the answer itself. */
...
export class LearnItem extends OdmInMemItem implements QuizzableData {
  ...
  /** Set when this item was created as part of an approved, bulk AI generation run. */
  whenBulkGeneratedByAi?: OdmTimestamp
  ...
  /** True when this item was created through a bulk AI generation flow. */
  isAiBulkGenerated(): boolean {
    return !! this.whenBulkGeneratedByAi
  }
